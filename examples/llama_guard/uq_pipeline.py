import pandas as pd
from experiment_utils import compute_accuracy
import pickle
...
def plot_deferral_accs(accuracy_with_deferral_bayesian_logreg, accuracy_with_deferral_logreg, accuracy_with_random_deferral, accuracy_with_optimal_deferral, omit_range):
...
def main(args):
    ...
    metrics_dict = compute_accuracy(llm_df)
    ...
    # compute accuracies after deferral 
