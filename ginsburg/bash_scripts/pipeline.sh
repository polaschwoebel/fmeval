...
--gp_path 'results/gp/openai_content_moderation/srgtlabels=model_response_prior=normal_D=500.p' \
--results_path 'results/plots/deferral_new/openai_content_moderation_llama3_70b_500d_horseshoe.png'