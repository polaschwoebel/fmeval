...
# Note: I have experimented with a fuzzy output parsing logic but this introduces a whole new set of problems. 
# E.g., what if more than one category is included in the output? Revisit later if needed.
